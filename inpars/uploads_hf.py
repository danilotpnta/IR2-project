...
class HuggingFaceUploader:
    def __init__(
        ...
        if gen_dataset_files:
            ...
            self.gen_dataset_files = [
                # Queries generated by Llama-3.1-8B
                ...
                # Queries generated by Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_Zero-shot.jsonl",
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_Zero-shot_filtered_all.jsonl",
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_Zero-shot_triplets.tsv",
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_CoT.jsonl",
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_CoT_filtered_all.jsonl",
                "queries_Meta-Llama-3.1-Instruct-8B_merged-16bit_CPO_MSMARCO_CoT_triplets.tsv",
    ...
    def upload_model_files(self, model: ModelConfig) -> None:
        ...
        print(
            f"\n** Uploading model files for dataset: {model.dataset_name}, strategy: {model.strategy} **"
        )
    ...
    def upload_dataset_files(self, dataset: DatasetConfig) -> None:
        ...
        print(f"\n** Uploading dataset files for: {dataset.dataset_name} **")
...
def load_config(config_path: str) -> tuple[List[ModelConfig], List[DatasetConfig], str]:
    ...
    for dataset_name, dataset_info in config_data["datasets"].items():
        for strategy, model_info in dataset_info["models"].items():
            models.append(
                ModelConfig(
